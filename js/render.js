...
const Rend = {
  ...
  ERA_GROUND: {
    ...
    12: {
      ...
      salt:     { color: 0xe0d2c4, tex: 'salt' },
      saltRidge: 0xf0e6da,
      rock:     { color: 0xa89f88, tex: 'rock' },
      cliff:    0x8a8270,
      bed:      0x2f7f92,
      grain: 0.11, macro: 0.14,
    },
    10: {
      base:     { color: 0xa8a68c, tex: 'silt' },
      fertile:  { color: 0x6b7a3e, tex: 'field' },
      salt:     { color: 0xd8d2be, tex: 'salt' },
      saltRidge: 0xe6e0cc,
      rock:     { color: 0xd2d0c4, tex: 'rock' },
      cliff:    0x9a968a,
      bed:      0x235f7e,
      grain: 0.14, macro: 0.16,
    },
    9: {
  ...
  ERA_SCATTER: {
    ...
    1:  { tree: ['deadTree'], scrub: [], scrubDensity: 0, marsh: [],
          rock: ['boulder'], crag: ['crag'] },
    4:  { tree: ['palm', 'poplar'], scrub: ['tamarisk'], scrubDensity: 0.055, marsh: [],
          rock: ['boulder'], crag: ['crag'] },
    5:  { tree: ['palm', 'acacia'], scrub: ['tamarisk'], scrubDensity: 0.05, marsh: [],
          rock: ['boulder'], crag: ['crag'] },
    ...
    13:  { tree: ['umbrella', 'cypress', 'olive'], scrub: ['bush'], scrubDensity: 0.11, marsh: [],
          rock: ['boulder'], crag: ['crag'] },
    22:  { tree: ['olive', 'cypress'], scrub: ['bush'], scrubDensity: 0.13, marsh: [],
          rock: ['boulder'], crag: ['crag'] },
    28:  { tree: ['cypress', 'poplar', 'olive'], scrub: ['bush'], scrubDensity: 0.10, marsh: [],
          rock: ['boulder'], crag: ['crag'] },
    30:  { tree: ['deadTree'], scrub: ['deadTree'], scrubDensity: 0.06, marsh: [],
          rock: ['slag'], crag: ['slag'] },
    33: { tree: ['streetTree'], scrub: ['bush'], scrubDensity: 0.07, marsh: [],
          rock: ['boulder'], crag: ['crag'] },
    34: { tree: ['streetTree'], scrub: ['bush'], scrubDensity: 0.06, marsh: [],
          rock: ['boulder'], crag: ['crag'] },
