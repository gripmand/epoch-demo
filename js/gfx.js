...
const Gfx = {
  ...
  ERA_GRADE: {
    ...
    16: { sky: ['#7d94ae', '#b6c0bc', '#e0d6c0'],
          ...
          fog: 0xd2d8dc, fogN: 105, fogF: 360, expo: 0.94,
          apron: 0x9fa392, sunDir: [-84, 66, -50],
          water: { color: 0x3f6a86, shallow: 0x8fb0bc, opacity: 0.88,
                   glint: 0xd8e4ec, glintAmt: 0.22 } },
    ...
    6: {
      sky: ['#6f93b5', '#b9c6cc', '#e8dfc9'], hemi: [0xe8dcc4, 0xa08a6e, 0.72],
      sun: [0xfff0d2, 1.24], fog: 0xd8cdb4, fogN: 90, fogF: 340, expo: 0.88,
    ...
    8: {
      sky: ['#7f9cb8', '#c2bea4', '#e8d9ae'], hemi: [0xc9d2dc, 0xb8a066, 0.74],
      sun: [0xffe9bd, 1.10], fog: 0xe0d3ad, fogN: 95, fogF: 330, expo: 0.90,
      apron: 0xc7b482, sunDir: [-88, 66, -60],
      water: { color: 0x8a7340, opacity: 0.94, shininess: 30, specular: 0xe0cf9e },
    },

    10: {
      sky: ['#3a72c0', '#8fb8d8', '#ecebdc'], hemi: [0xe8ecdc, 0x9a9880, 0.72],
      sun: [0xfff8e8, 1.36], fog: 0xdce6ea, fogN: 150, fogF: 460, expo: 0.95,
      apron: 0xbdb9a2, sunDir: [-70, 96, -46],
      water: { color: 0x1f6f96, shallow: 0x62b6c8, opacity: 0.84,
               shininess: 52, specular: 0x9ecada },
    },

    11: {
      sky: ['#4a7ab8', '#a8c2cc', '#f0e8d4'], hemi: [0xf0ead6, 0x8a8464, 0.74],
      sun: [0xfff2d8, 1.28], fog: 0xe4dcc4, fogN: 130, fogF: 430, expo: 0.96,
      apron: 0xb0a488, sunDir: [-66, 92, -50],
      water: { color: 0x6d7a4a, shallow: 0x9aa663, opacity: 0.86,
               shininess: 34, specular: 0xbcc08a },
    },

    12: {
      sky: ['#2f78c8', '#95c0dc', '#f6efe0'], hemi: [0xf6f0e2, 0x9a8f70, 0.80],
      sun: [0xfff8e6, 1.36], fog: 0xe8e0cc, fogN: 150, fogF: 470, expo: 0.92,
      apron: 0xc4b894, sunDir: [-74, 88, -44],
      water: { color: 0x2f7f92, shallow: 0x62b2b6, opacity: 0.84,
               shininess: 44, specular: 0xd0e2e6 },
    },

    15: {
      sky: ['#6d86a4', '#a8b4b0', '#d8cdb4'], hemi: [0xc9cfc4, 0x7a7460, 0.72],
      sun: [0xffeecd, 1.08], fog: 0xcfcbb8, fogN: 95, fogF: 330, expo: 0.92,
      apron: 0x9fa088, sunDir: [-88, 62, -54],
      water: { color: 0x46656a, shallow: 0x8aa39c, opacity: 0.90,
               glint: 0xcfe0d8, glintAmt: 0.18 },
    },
    13: {
      sky: ['#5a86bc', '#b4c6c4', '#f2e6cc'], hemi: [0xf2ead2, 0x8f8760, 0.76],
      sun: [0xfff0d2, 1.30], fog: 0xe6dcc0, fogN: 140, fogF: 460, expo: 0.94,
      apron: 0xb0a17c, sunDir: [-70, 90, -46],
      water: { color: 0x6d7a4a, shallow: 0x93a05e, opacity: 0.88,
               shininess: 28, specular: 0xb2b884 },
    },
    9: {
      sky: ['#3f7fc4', '#8fc4d9', '#dcecec'], hemi: [0xd2e8ee, 0x6f8a52, 0.80],
      sun: [0xfffaea, 1.24], fog: 0xd6e9ee, fogN: 130, fogF: 420, expo: 0.92,
      apron: 0x8aa068, sunDir: [-76, 82, -48],
      water: { color: 0x1f8fa8, shallow: 0x7fd8d2, opacity: 0.80,
               glint: 0xe6fbff, glintAmt: 0.30 },
    },
    14: {
